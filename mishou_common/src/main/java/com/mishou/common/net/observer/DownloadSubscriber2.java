...
/**
 * Created by ${shishoufeng} on 17/11/22.
 * email:shishoufeng1227@126.com
 */

public class DownloadSubscriber2<ResponseBody extends okhttp3.ResponseBody> extends BaseSubscriber<ResponseBody> {
    ...
    public DownloadSubscriber2(Context context, String path, String name, CallBack callBack) {
        super(context);
        this.path = path;
        this.name = name;
    ...
    @Override
    public void onErrorMessage(final ApiException e) {
        OnlyLog.d("DownSubscriber:>>>> onError:" + e.getMessage());
        finalonError(e);
    }

    @Override
    public void onNext(ResponseBody responseBody) {
        OnlyLog.d("DownSubscriber:>>>> onNext");
    ...
    private boolean writeResponseBodyToDisk(String path, String name, Context context, okhttp3.ResponseBody body) {
        OnlyLog.d("contentType:>>>>" + body.contentType().toString());
        ...
        try {
           ...
           /* if (!futureStudioIconFile.exists()) {
            ...
            try {
                ...
                OnlyLog.d("file length: " + fileSize);
                ...
                while (true) {
                    ...
                    OnlyLog.i("file download: " + fileSizeDownloaded + " of " + fileSize);
                    //下载进度
                                    ...
                                    .subscribe(new Consumer<Long>() {
                                        ...
                                        public void accept(@NonNull Long aLong) throws Exception {
                                            if (callBack instanceof DownloadCallback) {
                                                ((DownloadCallback) callBack).onProgress(finalFileSizeDownloaded, fileSize, finalFileSizeDownloaded == fileSize);
                                            }
                                        }
                ...
                outputStream.flush();
                OnlyLog.i("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                ...
                //final String finalName = name;
                    ...
                    Observable.just(finalPath)
                            ...
                            .subscribe(new Consumer<String>() {
                                ...
                                public void accept(@NonNull String s) throws Exception {
                                    if (callBack instanceof DownloadCallback) {
                                        ((DownloadCallback) callBack).onDownloadCompleted(finalPath);
                                    }
                                }
                            }, new Consumer<Throwable>() {
                                @Override
                    ...
                    OnlyLog.i("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                    OnlyLog.i("file downloaded: is sucess");
                }
