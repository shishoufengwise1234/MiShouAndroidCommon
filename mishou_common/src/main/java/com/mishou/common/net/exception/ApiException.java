...
public class ApiException extends Exception {
    ...
    public static ApiException parseException(Throwable e) {
        ...
        if (e instanceof HttpException) { //http 异常
            ...
            ex = new ApiException(e, OnlyConstants.ERROR_CODE.PARSE_ERROR);
            ex.message = "解析错误";
            return ex;
        } else if (e instanceof ClassCastException) {
            ex = new ApiException(e, OnlyConstants.ERROR_CODE.CAST_ERROR);
            ex.message = "类型转换错误";
            return ex;
        } else if (e instanceof ConnectException) {
            ex = new ApiException(e, OnlyConstants.ERROR_CODE.NETWORD_ERROR);
            ex.message = "连接失败";
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new ApiException(e, OnlyConstants.ERROR_CODE.SSL_ERROR);
            ex.message = "证书验证失败";
            return ex;
        } else if (e instanceof ConnectTimeoutException) {
            ex = new ApiException(e, OnlyConstants.ERROR_CODE.TIMEOUT_ERROR);
            ex.message = "连接超时";
            return ex;
            ...
            ex = new ApiException(e, OnlyConstants.ERROR_CODE.UNKNOWN);
            ex.message = "未知错误";
            return ex;
        }
    }
