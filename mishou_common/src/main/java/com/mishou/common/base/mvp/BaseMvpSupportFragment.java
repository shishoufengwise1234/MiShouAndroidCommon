...
public abstract class BaseMvpSupportFragment<P extends IBasePresenter> extends RxFragment implements IBaseView<P>{
    ...
    /**
     * 注解view
     * @param baseMvpSupportFragment
     * @param view
     */
    private void bindView(BaseMvpSupportFragment baseMvpSupportFragment, View view) {
        unbinder = ButterKnife.bind(baseMvpSupportFragment,view);
    }
