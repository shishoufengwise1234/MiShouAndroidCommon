...
public abstract class BaseMvpLazyLoadFragment<P extends IBasePresenter> extends RxFragment implements IBaseView<P> {
    ...
    /**
     * 注解view
     * @param baseMvpLazyLoadFragment
     * @param view
     */
    private void bindView(BaseMvpLazyLoadFragment baseMvpLazyLoadFragment, View view) {
        unbinder = ButterKnife.bind(baseMvpLazyLoadFragment,view);
    }
