...
public class StringUtils {
    ...
    private static final String regex  = "[\u4e00-\u9fff]";// 中文
...
//            Pattern regex = Pattern.compile("^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,20}$");
     ...
     * @return
     */
    public static boolean checkVinNum(String vin){
        boolean flag = false;
        try {
//            Pattern regex = Pattern.compile("^[0-9a-zA-Z]{17}$");
            Pattern regex = Pattern.compile("^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{17}$");
    ...
    public static boolean isHttp(String url){
        return !isEmpty(url) && (url.contains("https") || url.contains("http"));
    }
     ...
     * @return
     */
    public static boolean isContains(CharSequence target, CharSequence value){
        return !isEmpty(target) && !isEmpty(value) && target.toString().contains(value);
    }
