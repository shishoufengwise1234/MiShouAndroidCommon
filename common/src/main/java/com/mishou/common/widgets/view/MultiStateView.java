...
public class MultiStateView extends FrameLayout {
    ...
    public static final int VIEW_STATE_NO_NET = 4;

    @Retention(RetentionPolicy.SOURCE)
    @IntDef({VIEW_STATE_UNKNOWN, VIEW_STATE_CONTENT, VIEW_STATE_ERROR, VIEW_STATE_EMPTY, VIEW_STATE_LOADING,VIEW_STATE_NO_NET})
    ...
    private void init(AttributeSet attrs) {
        ...
        int netViewResId = a.getResourceId(R.styleable.MultiStateView_msv_netView, -1);
        if (netViewResId > -1) {
            mNetView = mInflater.inflate(netViewResId, this, false);
            addView(mNetView, mNetView.getLayoutParams());
        }
        ...
        switch (viewState) {
            ...
            case VIEW_STATE_LOADING:
                ...
                break;
            case VIEW_STATE_NO_NET:
                mViewState = VIEW_STATE_NO_NET;
                break;
    ...
    /**
     * Returns the {@link View} associated with the {@link com.mishou.common.widgets.view.MultiStateView.ViewState}
     *
     * @param state The {@link com.mishou.common.widgets.view.MultiStateView.ViewState} with to return the view for
     * @return The {@link View} associated with the {@link com.mishou.common.widgets.view.MultiStateView.ViewState}, null if no view is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link com.mishou.common.widgets.view.MultiStateView.ViewState}
     *
     * @return
     */
    @ViewState
    ...
    /**
     * Sets the current {@link com.mishou.common.widgets.view.MultiStateView.ViewState}
     *
     * @param state The {@link com.mishou.common.widgets.view.MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link com.mishou.common.widgets.view.MultiStateView.ViewState}
     */
    private void setView(@ViewState int previousState) {
        switch (mViewState) {
            case VIEW_STATE_LOADING:
                ...
                if (mNetView != null) mNetView.setVisibility(GONE);
            ...
            case VIEW_STATE_NO_NET:
                if (mNetView == null) {
                    throw new NullPointerException("net View");
                }
    ...
    private boolean isValidContentView(View view) {
        ...
        return view != mLoadingView && view != mErrorView && view != mEmptyView && view != mNetView;
    }
     ...
     * @param state         The {@link com.mishou.common.widgets.view.MultiStateView.ViewState}to set
     * @param switchToState If the {@link com.mishou.common.widgets.view.MultiStateView.ViewState} should be switched to
     */
    public void setViewForState(View view, @ViewState int state, boolean switchToState) {
        switch (state) {
            ...
            case VIEW_STATE_ERROR:
                ...
                break;
            case VIEW_STATE_NO_NET:
                if (mNetView != null) removeView(mNetView);
                mNetView = view;
                addView(mNetView);
                break;
    ...
    /**
     * Sets the {@link View} for the given {@link com.mishou.common.widgets.view.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link com.mishou.common.widgets.view.MultiStateView.ViewState} to set
     */
