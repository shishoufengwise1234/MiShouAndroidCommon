...
public abstract class BaseMvpAppcompatActivity<P extends IBasePresenter> extends RxAppCompatActivity implements IBaseView<P>{


    private static final String TAG = "BaseMvpAppcompatActivity";
