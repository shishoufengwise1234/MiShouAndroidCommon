...
import com.mishou.common.net.json.JsonNullStringToEmptyAdapterFactory;
    ...
    public ApiResultFunction(@Nullable Gson gson, @NonNull Type type) {
        if (gson == null) {
            this.mGson = new GsonBuilder()
                    ...
                    .serializeNulls()
                    .registerTypeAdapterFactory(new JsonNullStringToEmptyAdapterFactory<T>())
                    .create();
        } else {
            this.mGson = gson;
        }
            ...
            if (ApiResult.class.isAssignableFrom(cls)) {
                ...
                try {
                    ...
                    if (!List.class.isAssignableFrom(rawType) && clazz.equals(String.class)) {
                        ...
                        //暂时取消baseData 数据格式转换
//                    }else if (clazz.equals(BaseData.class)){  // 数据是BaseData
//                        ApiResult result = mGson.fromJson(json, type);
//                        if (result != null) {
//                            apiResult = result;
//                            if (apiResult.getData() == null) {  //
//                                apiResult.setData((T) new BaseData());
//                            }
//                        }else{
//                            apiResult.setMessage("json is null");
//                        }
//                    } else if (BaseData.class.isAssignableFrom(clazz)) {  // 继承了 BaseData
//                        ApiResult result = mGson.fromJson(json, type);
//                        if (result != null) {
//                            apiResult = result;
//                            if (apiResult.getData() == null) {  //
//                                apiResult.setData((T) clazz.newInstance());
//                            }
//                        }else{
//                            apiResult.setMessage("json is null");
//                        }
